...
from ARISHFA_MUSIC.misc import _boot_
from ARISHFA_MUSIC.plugins.sudo.sudoers import sudoers_list
from ARISHFA_MUSIC.utils.database import (
    add_served_chat,
    add_served_user,
    blacklisted_chats,
    get_lang,
...
async def start_pm(client, message: Message, _):
    ...
    started_msg = await message.reply_text(text="<b>sᴛᴀʀᴛᴇᴅ...<a href='https://files.catbox.moe/mfzavs.mp4' target='_blank'>ㅤ ㅤㅤㅤ</a></b>")
